...
\begin{figure}
 \centering
\includegraphics[width=3.0in]{figs/DirectedGraphExample.png}
\end{figure}
...
\begin{figure}
 \centering
\includegraphics[width=3.0in]{figs/WikipediaPowerLawGraph.png}
...
\begin{figure}
 \centering
\includegraphics[width=3.0in]{figs/AllThreeScaleFree.png}
