...
\begin{figure}
  ...
  \begin{minipage}{3in}
  \begin{center}
    \includegraphics[width=1\textwidth]{antchoice.jpg}
  \end{center}
  \vspace{-20pt}
  \caption{In the model, ants live in a grid and face away from the nest. At each time step, they can move forward left or forward right.}
  \label{fig:antchoice}
  \end{minipage}
  }
  \vspace{-20pt}
...
\begin{figure}[h]
  % \vspace{-20pt}
  \begin{center}
    \includegraphics[width=0.48\textwidth]{plot.png}
  \end{center}
