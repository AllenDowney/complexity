...
will get back to instrumentalism in Chapter~\ref{life} and
...
These arguments reconcile the same conflict in opposite ways, but they
agree that there is a conflict: the system cannot have free will if
the parts are deterministic.

The complex systems we have seen in this book suggest the premise that
free will, at the level of options and decisions, is compatible with
determinism at the level of neurons (or some lower level).  In the
same way that a traffic jam moves backward while the cars move
