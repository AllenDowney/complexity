...
incidents of cheating.  At other colleges, cheating is rare and likely
...
The parameters of the simulation affect the probability of landing
in the two clusters


From a societal point of view, low {\tt boldness} is good
...
proportion of players with high boldness is low.

For the following
analysis, we define a good outcome as the situation where, after 300
generations, the mean boldness is 0.4 or less.

Figure~\ref{fig.varyCP}
...
Analyze the cheat-or-not subgame---under what circumstances should an
individual cheat?  Then download
